...
-- leetcode 1407 (IFNULL(ex1, ex2) ; 레코드의 어떤 값이 null일때, null 대신 다른 값을 가져온다로 이해)
# sub query
 SELECT name, 
...
-- leetcode 1965 (right join + left join = union 사용해서 결합)  
...
FROM Employee e RIGHT JOIN Salaries s
 ON e.employee_id = s.employee_id

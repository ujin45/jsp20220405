...
<body>
	...
	<%-- http://localhost:8080/jsp99/chap12/01if/ex02.jsp?num1=45&num2=99 --%>
	...
	<c:if test="${(not empty param.num1) and (not empty param.num2) }" var="myTest" scope="page"> <%--pageScope Attribute : myTest --%>
